...
const icons: React.FC[] = [
  // 1. Flip flops
  () => (
    <svg width="32" height="32" viewBox="0 0 20 20" fill={ICON_COLOR}>
  ...
  // 15. Anchor
  () => (
    <svg width="32" height="32" viewBox="0 0 20 20" fill="none" stroke={ICON_COLOR} strokeWidth="1.5" strokeLinecap="round">
...
export function FloatingIcon() {
  ...
  useEffect(() => {
    if (!animating) return;
    // Animation lasts 7s, then we advance
