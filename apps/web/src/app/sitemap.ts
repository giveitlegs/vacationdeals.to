...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages = [
    ...
    { url: `${baseUrl}/will-it-hold-up`, lastModified: new Date(), changeFrequency: "weekly" as const, priority: 0.9 },
    ...
    { url: `${baseUrl}/vacpack-games/59-challenge`, lastModified: new Date(), changeFrequency: "weekly" as const, priority: 0.6 },
    { url: `${baseUrl}/vacpack-games/time-machine`, lastModified: new Date(), changeFrequency: "daily" as const, priority: 0.7 },
    { url: `${baseUrl}/vacpack-games/scratch-off`, lastModified: new Date(), changeFrequency: "daily" as const, priority: 0.7 },
